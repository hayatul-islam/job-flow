    ...
    <section className="relative overflow-hidden pb-12 bg-light-background">
      <div className="relative z-10 container mt-24 lg:mt-32 grid w-full flex-1 items-center gap-12 pb-8 lg:pb-16 lg:grid-cols-5 px-6 lg:px-8">
        <div className="lg:col-span-3 flex flex-col items-center text-center lg:items-start lg:text-left">
          <div className="hidden md:inline-flex mb-2 lg:mb-7 items-center gap-2 rounded-full border-primary/10 bg-primary/3 px-4 py-2 text-[10px] sm:text-xs text-primary">
            <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-green-500" />
            2,400 jobs added this week
          </div>

          <h1 className="mb-4 lg:mb-8 md:leading-[0.95] font-bold max-w-lg">
            <span className="lg:block">Land your</span>
            <span className="lg:block lg:italic">dream job </span>
            <span className="lg:block lg:italic lg:font-light lg:text-[0.83em]">
              without the grind.
            </span>
          </h1>

          <p className="pb-6 lg:mb-9 max-w-xl leading-relaxed text-[14px] md:text-[16px]">
