...
//         {/* Top row — always flex, wraps on mobile */}
//         <div className="flex flex-wrap items-center justify-between gap-2 px-4 py-2.5 bg-white/80 border-b border-gray-100">
//           <div className="flex items-center gap-2.5 min-w-0">
//             <div className="w-8 h-8 rounded-lg bg-white border border-gray-200 flex items-center justify-center text-xs font-semibold text-primary shrink-0">
//               {employerFirstLetter}
//             </div>
//             <div className="min-w-0">
//               <h6 className="truncate">{employerName}</h6>
//               <p className="flex items-center gap-1 !text-xs">
//                 <MapPin className="w-2.5 h-2.5 shrink-0" />
...
//           <h6 className="truncate">{job.title}</h6>
